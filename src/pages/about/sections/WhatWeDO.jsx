...
export default function WhatWeDo() {
  ...
  return (
    <section className="relative w-full h-[500px] md:h-[800px] overflow-hidden">
      ...
      <div className="absolute right-6 md:right-16 top-1/2 -translate-y-1/2 bg-[#0b1220] text-white p-6 md:p-8 rounded-2xl w-[300px] md:w-[550px] md:h-[250px] shadow-xl transition-all duration-300">
        <h2 className="text-xl md:text-4xl font-semibold mb-4 text-blue-400">
          What We Do
        </h2>

        <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm transition-all duration-300">
  ...
  bg-[#252832] w-[250px] py-2 rounded-full shadow-lg"
          >
            <button
              onClick={prev}
