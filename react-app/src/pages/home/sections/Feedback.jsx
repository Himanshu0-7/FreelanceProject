...
export default function Feedback() {
  return (
    <section className="relative w-full py-16 sm:py-20 flex flex-col gap-6 overflow-hidden bg-gradient-90-light dark:bg-gradient-180-dark">
      {/* Background images */}
      <img
        src={Background}
        alt=""
      ...
      <div className="relative z-10 text-center px-6">
        <h1 className="text-[var(--special-text)] text-3xl sm:text-4xl md:text-5xl font-semibold">
          Client <span className="text-[var(--primary)]">We Served</span>
        </h1>

        <p className="text-[var(--text)] font-semibold text-base sm:text-lg md:text-xl mt-3 leading-relaxed max-w-3xl mx-auto">
      ...
      <div className="relative z-10 px-4 sm:px-10 lg:px-20">
        <div className="relative py-4">
          {/* Corner brackets */}
          <span className="absolute top-0 z-10 left-0 w-6 sm:w-10 h-6 sm:h-10 border-t-[1.5px] border-l-[1.5px] border-[var(--card-border2)]" />

          <span className="absolute top-0 z-10 right-0 w-6 sm:w-10 h-6 sm:h-10 border-t-[1.5px] border-r-[1.5px] border-[var(--card-border2)]" />

          <span className="absolute bottom-0 z-10 left-0 w-6 sm:w-10 h-6 sm:h-10 border-b-[1.5px] border-l-[1.5px] border-[var(--card-border2)]" />

          <span className="absolute bottom-0 z-10 right-0 w-6 sm:w-10 h-6 sm:h-10 border-b-[1.5px] border-r-[1.5px] border-[var(--card-border2)]" />
