...
export default function Services() {
  ...
  return (
    <section className="relative w-full min-h-dvh flex flex-col items-center py-16 sm:py-20 px-6 sm:px-10 lg:px-16 overflow-hidden bg-gradient-270-light dark:bg-gradient-270-dark">
      ...
      {/* Cards */}
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-16 mt-16 mb-16 w-full max-w-[1200px]">
      ...
      <button
        ...
        className="relative z-10 mt-8 px-8 sm:px-10 py-3 sm:py-4 rounded-full text-white font-semibold bg-btn-light dark:bg-btn-dark hover:opacity-90 transition duration-300"
      >
        Hire Us Today →
      </button>
    </section>
